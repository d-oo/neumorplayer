...
create table if not exists tracks (
  ...
  category text not null check (category in ('Song','Inst')),
...
create index if not exists tracks_recent_add_idx on tracks (user_id, category, created_at desc);
create index if not exists tracks_recent_play_idx on tracks (user_id, category, recent_play desc);
create index if not exists tracks_most_play_idx on tracks (user_id, category, play_count desc);
